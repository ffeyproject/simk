...
<head>
    ...
    <title>Coming Soon - Website Dojo Utama</title>
    <link rel="icon" type="image/x-icon" href="{{ asset('coming/assets/favicon.ico') }}" />
...
<body>
    ...
    <video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
        <source src="{{ asset('coming/assets/mp4/pertama.mp4') }}" type="video/mp4" />
    </video>
    <!-- Masthead-->
    <div class="masthead">
        <div class="masthead-content text-white">
            <div class="container-fluid px-4 px-lg-0">
                <h1 class="fst-italic lh-1 mb-4">BKC DOJO UTAMA Website is Coming Soon</h1>
